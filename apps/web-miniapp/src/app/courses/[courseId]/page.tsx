            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="grid grid-cols-2 gap-2.5">
                {[
                  ...
                  { icon: '🤖', title: 'AI-ассистент Franklin', desc: 'Персональный помощник объяснит любой урок и проверит задание' },
                  ...
                  { icon: '🏆', title: 'Сертификат', desc: 'Официальный сертификат об окончании курса Franklin Learning' },
