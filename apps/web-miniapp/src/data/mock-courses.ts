          ...
          blocks: [
            {
              ...
              type: 'VIDEO',
              title: 'Введение в курс',
              videoUrl: 'https://pub-d38d77916ee1492ca4ee55002e27caca.r2.dev/0310%20(1).mp4',
              duration: '~5 мин',
            },
          ],
        },
          ...
          blocks: [
            {
              ...
              content: `## Модуль 0: Введение

Это вводная точка курса. Здесь ты поймёшь, как устроена вся система заработка на AI-моделях.

Здесь ты узнаешь:
- Как работает вся модель бизнеса
- Из каких этапов состоит заработок
- Какие инструменты будут использоваться
- Как проходить курс правильно, чтобы получить результат

Это карта всего пути. После этого блока ты будешь понимать, что и зачем мы будем делать дальше.

**1. Как будет проходить обучение**

Ты уже посмотрел вводный урок — теперь важно понять, как правильно проходить курс, чтобы получить результат.

**2. Как устроено обучение**

Весь курс построен пошагово. Каждый раздел — это отдельный этап системы. Не нужно перепрыгивать между темами. Иди строго по порядку, потому что каждый следующий шаг строится на предыдущем.

Этапы:
- Сначала создаётся модель
- Потом запускается трафик
- Потом создаётся контент
- Потом подключается монетизация
- Потом происходит масштабирование

Если пропустить один из этапов — система работать не будет.

**3. Как правильно проходить курс**

Самая большая ошибка — просто смотреть уроки. Этот курс нужно проходить практически. После каждого раздела:
- Повторяй действия из видео
- Делай всё сразу на практике
- Не переходи дальше, пока не сделал предыдущий шаг

**4. Обязательный квиз после уроков**

После каждого модуля тебе будет доступен квиз. Это короткий тест, который помогает закрепить материал, убедиться что ты понял тему и проверить ключевые моменты. Чтобы перейти дальше — нужно пройти квиз. Это сделано специально для осознанного обучения.

**5. Используй заметки во время обучения**

Во время уроков ты можешь добавлять заметки прямо внутри курса:
- Сохранять важные моменты обучения
- Формировать свои личные конспекты
- Возвращаться к нужному в любой момент

**6. Вопросы и помощь Артемиуса**

Если какой-то момент непонятен — используй Артемиуса. Ты сможешь задать вопрос по теме и получить пояснение прямо внутри курса. Артемиус доступен через иконку в правом нижнем углу.

**7. Сколько времени нужно**

У каждого темп будет разный. Главное — двигаться шаг за шагом и не бросать на полпути.

> Этот курс — не про теорию. Он про систему: создание модели, трафик, контент, монетизация и масштабирование. Если всё сделать правильно — получается рабочая модель заработка.`,
            },
          ],
        },
      ],
      ...
      lessons: [
        {
          ...
          duration: '~10 мин',
          blocks: [
            { id: 'b2-1', type: 'VIDEO', title: 'Модели в Nano Banano', videoUrl: 'https://pub-d38d77916ee1492ca4ee55002e27caca.r2.dev/ai%201-1.mp4', duration: '~10 мин' },
          ],
        },
        {
          id: 'l2-2',
          ...
          duration: '~10 мин',
          blocks: [
            { id: 'b2-2', type: 'VIDEO', title: 'Контент в Nano Banano', videoUrl: 'https://pub-d38d77916ee1492ca4ee55002e27caca.r2.dev/ai%201-2.mp4', duration: '~10 мин' },
          ],
        },
        {
          id: 'l2-3',
