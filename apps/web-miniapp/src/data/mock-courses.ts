          ...
          blocks: [
            {
              ...
              type: 'VIDEO',
              title: 'Введение в курс',
              videoUrl: 'https://pub-d38d77916ee1492ca4ee55002e27caca.r2.dev/ai%200-1.mp4',
              duration: '~5 мин',
            },
          ],
        },
...
**6. Вопросы и помощь Nero**

Если какой-то момент непонятен — используй Nero. Ты сможешь задать вопрос по теме и получить пояснение прямо внутри курса. Nero доступен через иконку в правом нижнем углу.
