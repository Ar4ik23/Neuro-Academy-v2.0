    ...
    const response = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: `Ты — Артемиус, AI-помощник курса по заработку на AI-моделях. Отвечай кратко, по делу, на русском языке. Будь дружелюбным и поддерживающим. Контекст урока: ${context || 'не указан'}`,
          },
