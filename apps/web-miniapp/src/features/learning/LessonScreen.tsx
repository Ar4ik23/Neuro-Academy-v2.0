  ...
  return (
    <div className="flex flex-col animate-enter min-h-screen">
      <header className="sticky top-0 z-50 glass-card p-4 flex items-center gap-4">
        ...
        <h1 className="text-md font-bold text-text-1 truncate">{lesson.title}</h1>
      </header>
      ...
      <footer className="sticky bottom-0 p-4 glass-card border-t border-[rgba(255,255,255,0.07)]">
        <button
          onClick={onComplete}
          className="btn-primary w-full py-4 rounded-2xl font-black shadow-glow-primary active:scale-95 transition-transform"
        >
          УРОК ЗАВЕРШЁН
        </button>
      </footer>
